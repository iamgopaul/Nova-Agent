  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        <div
          className={cn(
            "relative flex items-end gap-1.5 sm:gap-2 rounded-2xl border border-white/8 bg-white/4 p-2.5 sm:p-3 transition-all duration-200",
        ...
        >
          ...
          <button
            ...
            className="shrink-0 mb-0.5 p-2 sm:p-1.5 rounded-lg text-white/25 hover:text-white/60 hover:bg-white/7 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
          ...
          <div className="flex items-center gap-1 shrink-0 mb-0.5">
            {!isStreaming && !value && (
              <button
                ...
                className="p-2 sm:p-1.5 rounded-lg text-white/25 hover:text-white/60 hover:bg-white/7 transition-colors"
                title="GAAIA Voice"
              >
          ...
          <div className="mt-2 flex flex-wrap gap-1.5 max-w-3xl mx-auto">
            {attachments.map((file, index) => (
              <div
                ...
                className="flex items-center gap-2 max-w-full rounded-lg border border-blue-500/20 bg-blue-500/7 px-2.5 py-1.5 text-xs text-white/60"
              >
                ...
                <button
                  ...
                  className="w-4 h-4 rounded flex items-center justify-center text-white/25 hover:text-white/70 hover:bg-white/10 transition-colors"
