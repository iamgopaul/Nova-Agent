"""
GAAIA Chart router — matplotlib-powered chart generation.
...
The spec format matches what GAIA Core emits in ```json blocks during chat.
"""
...
async def generate_chart_endpoint(body: ChartRequest) -> Response:
    ...
    from gaaia.services.chart_generator import generate_chart
