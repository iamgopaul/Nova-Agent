...
def build_system_prompt(
    ...
    text += (
        ...
        "- **NEVER pivot from a factual question to creative writing.** "
        "If the message is a factual question — contains do/does/is/are/can/will/what/when/where/who/why/how "
        "and does NOT contain 'write', 'create', 'tell me a story', 'compose' — answer it directly. "
        "Example: 'Do kids on an E2 visa need a SSN?' → one direct factual answer. "
        "Do NOT write a story, poem, or narrative about the topic. Do NOT say 'On request, I will write…' — "
        "if they didn't ask for creative writing, don't offer or produce it.\n"
