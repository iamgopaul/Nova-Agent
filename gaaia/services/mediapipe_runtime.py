...
def get_hand_landmarker():
    ...
    with _lock:
        ...
        print("[GAIA] MediaPipe HandLandmarker (Tasks) ready.", flush=True)
        return _hand_lm
...
def get_face_detector():
    ...
    with _lock:
        ...
        from gaaia.services.mediapipe_resources import face_detector_model_path
        ...
        print("[GAIA] MediaPipe FaceDetector (Tasks) ready.", flush=True)
        return _face_det
...
def get_pose_landmarker():
    ...
    with _lock:
        ...
        from gaaia.services.mediapipe_resources import pose_landmarker_model_path

        _pose_lm = pl.PoseLandmarker.create_from_model_path(str(pose_landmarker_model_path()))
        print("[GAIA] MediaPipe PoseLandmarker (Tasks) ready.", flush=True)
        return _pose_lm
