...
from nova.services.frame_detection import detect_all as _detect_all
...
async def ingest_live_frame(
    ...
    """
    Push frames while the UI is open; Nova prepends the latest rolling summary to voice + text chat.
...
async def delete_profile(name: str, request: Request):
    ...
    from nova.server.routers.voice import _get_speaker_identity
