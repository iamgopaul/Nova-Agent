"""
Nova Debate — 4-model battle royale with elimination rounds.
...
def _pick_contestants(settings) -> tuple[list[dict], dict]:
    ...
    slots = [
        ("alpha", ["fast_model",  "swift_model", "core_model"],              "Nova Spark", "blue"),
        ("beta",  ["swift_model", "fast_model",  "core_model"],              "Nova Air",   "violet"),
        ("gamma", ["core_model",  "mind_model",  "name"],                    "Nova Core",  "amber"),
        ("delta", ["heavy_model", "name",        "core_model", "mind_model"],"Nova Pro",   "rose"),
    ]
    ...
    judge = {"model": judge_model, "identity": "Nova Judge"}
